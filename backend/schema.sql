...
CREATE TABLE IF NOT EXISTS stock_in_history (
  ...
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT fk_stock_in_history_product FOREIGN KEY (product_id) REFERENCES products (id) ON DELETE CASCADE,
  CONSTRAINT fk_stock_in_history_user FOREIGN KEY (created_by) REFERENCES users (id) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS stock_audit_history (
  ...
  created_by INT UNSIGNED DEFAULT NULL,
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT fk_stock_audit_history_product FOREIGN KEY (product_id) REFERENCES products (id) ON DELETE CASCADE,
  CONSTRAINT fk_stock_audit_history_user FOREIGN KEY (created_by) REFERENCES users (id) ON DELETE SET NULL,
